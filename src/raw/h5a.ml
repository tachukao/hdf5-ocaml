...
external create :
  Hid.t -> string -> Hid.t -> ?acpl:Hid.t -> ?aapl:Hid.t -> Hid.t -> Hid.t
  = "hdf5_h5a_create_bytecode" "hdf5_h5a_create"

external create_by_name :
  Hid.t -> string -> string -> Hid.t -> ?acpl:Hid.t -> ?aapl:Hid.t -> ?lapl:Hid.t -> Hid.t -> Hid.t
  = "hdf5_h5a_create_by_name_bytecode" "hdf5_h5a_create_by_name"

external open_ : Hid.t -> ?aapl:Hid.t -> string -> Hid.t = "hdf5_h5a_open"

external open_by_name :
  Hid.t -> ?aapl:Hid.t -> ?lapl:Hid.t -> string -> string -> Hid.t
  = "hdf5_h5a_open_by_name"

external open_name : Hid.t -> string -> Hid.t = "hdf5_h5a_open_name"

external open_by_idx :
  Hid.t -> ?aapl:Hid.t -> ?lapl:Hid.t -> H5_raw.Index.t -> H5_raw.Iter_order.t -> int -> Hid.t
...
external exists_by_name :
  Hid.t -> string -> ?lapl:Hid.t -> string -> bool
  = "hdf5_h5a_exists_by_name"

external rename : Hid.t -> string -> string -> unit = "hdf5_h5a_rename"

external rename_by_name :
  Hid.t -> string -> ?lapl:Hid.t -> string -> string -> unit
  = "hdf5_h5a_rename_by_name"

external write_bigarray :
  Hid.t -> Hid.t -> _ Bigarray.Genarray.t -> unit
...
external read_bigarray : Hid.t -> Hid.t -> _ Bigarray.Genarray.t -> unit = "hdf5_h5a_read_bigarray"
...
external read_string_array : Hid.t -> Hid.t -> string array -> unit = "hdf5_h5a_read_string_array"
external close : Hid.t -> unit = "hdf5_h5a_close"

external iterate :
     Hid.t
  -> ?idx_type:H5_raw.Index.t
  -> ?iter_order:H5_raw.Iter_order.t
  -> ?n:int ref
  -> 'a Iterate.t
  -> 'a
  -> H5_raw.Iter.t
...
external iterate_by_name :
  ...
  -> 'a
  -> H5_raw.Iter.t
  = "hdf5_h5a_iterate_by_name_bytecode" "hdf5_h5a_iterate_by_name"

external delete : Hid.t -> string -> unit = "hdf5_h5a_delete"

external delete_by_name :
  Hid.t -> ?lapl:Hid.t -> string -> string -> unit
  = "hdf5_h5a_delete_by_name"

external delete_by_idx :
     Hid.t
  -> string
  -> ?idx_type:H5_raw.Index.t
  -> ?iter_order:H5_raw.Iter_order.t
...
external get_info_by_name :
  Hid.t -> string -> ?lapl:Hid.t -> string -> Info.t
  = "hdf5_h5a_get_info_by_name"

external get_info_by_idx :
     Hid.t
  -> string
  -> ?idx_type:H5_raw.Index.t
  -> ?order:H5_raw.Iter_order.t
  -> ?lapl:Hid.t
  -> int
  -> Info.t

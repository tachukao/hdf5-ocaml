...
external create_hard
  ...
  -> string
  -> unit
  = "hdf5_h5l_create_hard_bytecode" "hdf5_h5l_create_hard"

external create_soft
  :  string
  -> Hid.t
  -> ?lcpl:Hid.t
  -> ?lapl:Hid.t
...
external create_external
  ...
  -> string
  -> unit
  = "hdf5_h5l_create_external_bytecode" "hdf5_h5l_create_external"
...
external iterate
  ...
  -> 'a
  -> H5_raw.Iter.t
  = "hdf5_h5l_iterate_bytecode" "hdf5_h5l_iterate"
...
external get_name_by_idx
  ...
  -> int
  -> string
  = "hdf5_h5l_get_name_by_idx_bytecode" "hdf5_h5l_get_name_by_idx"

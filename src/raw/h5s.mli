...
external create_simple
  :  ?maximum_dims:Hsize.t array
  -> Hsize.t array
  -> Hid.t
  = "hdf5_h5s_create_simple"

external get_simple_extent_dims
  :  Hid.t
  -> Hsize.t array * Hsize.t array
...
external set_extent_simple
  :  Hid.t
  -> ?maximum_size:Hsize.t array
  -> Hsize.t array
  -> unit
...
external get_select_hyper_blocklist
  :  ?startblock:int
  -> ?numblocks:int
  -> Hid.t
  -> Hsize.t array
  = "hdf5_h5s_get_select_hyper_blocklist"

external get_select_elem_pointlist
  :  ?startblock:int
  -> ?numpoints:int
  -> Hid.t
  -> Hsize.t array
  = "hdf5_h5s_get_select_elem_pointlist"

external get_select_bounds : Hid.t -> int * int = "hdf5_h5s_get_select_bounds"

external select_elements
  :  Hid.t
  -> Select.t
  -> Hsize.t array
  -> unit
...
external select_hyperslab
  :  Hid.t
  -> Select.t
  -> start:Hsize.t array
  -> ?stride:Hsize.t array
  -> count:Hsize.t array
  -> ?block:Hsize.t array
  -> unit
  -> unit

...
external open_name : Hid.t -> string -> Hid.t = "hdf5_h5a_open_name"
  [@@ocaml.deprecated
    "This function is deprecated in favor of the function H5a.open_by_name"]
...
external open_idx : Hid.t -> int -> Hid.t = "hdf5_h5a_open_idx"
  [@@ocaml.deprecated
    "This function is deprecated in favor of the function H5a.open_by_idx"]
...
external get_num_attrs : Hid.t -> int = "hdf5_h5a_get_num_attrs"
  [@@ocaml.deprecated
    "This function is deprecated in favor of the functions H5o.get_info, \
     H5o.get_info_by_name, and H5o.get_info_by_idx"]

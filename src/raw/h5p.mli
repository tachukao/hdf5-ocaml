...
external set_create_intermediate_group
  :  Hid.t
  -> bool
  -> unit
  = "hdf5_h5p_set_create_intermediate_group"

external get_create_intermediate_group
  :  Hid.t
  -> bool

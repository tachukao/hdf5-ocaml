...
module S1 = struct
  ...
  let get_a t i =
    Array1.unsafe_get (Obj.magic t : (int32, int32_elt, c_layout) Array1.t) (i * 4)


  let set_a t i v =
    Array1.unsafe_set (Obj.magic t : (int32, int32_elt, c_layout) Array1.t) (i * 4) v
  ...
  let get_c t i =
    Array1.unsafe_get
      (Obj.magic t : (float, float64_elt, c_layout) Array1.t)
      ((i * 2) + 1)
...
module S2 = struct
  ...
  let get_c t i =
    ...
    then
      Array1.unsafe_get
        (Obj.magic t.t0 : (float, float64_elt, c_layout) Array1.t)
        (i / 2 * 3)
    else
      Array1.unsafe_get
        (Obj.magic t.t4 : (float, float64_elt, c_layout) Array1.t)
        ((i / 2 * 3) + 1)
  ...
  let get_a t i =
    Array1.unsafe_get
      (Obj.magic t.t0 : (int32, int32_elt, c_layout) Array1.t)
      ((i * 3) + 2)

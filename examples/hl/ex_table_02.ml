...
let () =
  ...
  Particle.(
    set (Vector.append p_data) ~name:"zero" ~lati:0 ~longi:0 ~pressure:0. ~temperature:0.);
  Particle.(
    set
      (Vector.append p_data)
      ~name:"one"
      ~lati:10
      ~longi:10
      ~pressure:1.
